...
-- ----------------------------
BEGIN;
INSERT INTO `ez_cloud_function` VALUES (1, NULL, 'c4ca4238a0b923820dcc509a6f75849b', 1, '获取用户数据云函数', 1, '获取用户数据云函数获取用户数据云函数', '    public CloudFunctionController(HttpServletRequest httpServletRequest) {\r\n        super(httpServletRequest);\r\n    }\r\n', 0, 0, '2020-04-12 18:19:35');
INSERT INTO `ez_cloud_function` VALUES (2, NULL, 'c81e728d9d4c2f636f067f89cc14862c', 1, '返回设备', 1, '获取用户数据云函数获取用户数据云函数', '    protected R get(@PathVariable Long id) throws XException {\r\n        CloudFunction cloudFunction = iCloudFunctionService.getById(id);\r\n        if (cloudFunction == null) {\r\n            throw new BizException(\"CloudFunction not exists\", \"云函数不存在\");\r\n\r\n        }\r\n        return data(cloudFunction);\r\n    }\r\n', 0, 0, '2020-04-12 18:19:35');
INSERT INTO `ez_cloud_function` VALUES (3, NULL, 'eccbc87e4b5ce2fe28308fd9f2a7baf3', 1, '读取系统参数', 1, '获取用户数据云函数获取用户数据云函数', 'CREATE TABLE `ez_cloud_function` (\n  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT \'PK\',\n  `cloud_app_id` int DEFAULT NULL,\n  `user_id` int DEFAULT NULL COMMENT \'User ID\',\n  `label` varchar(20) NOT NULL COMMENT \'UI显示的标签\',\n  `enable` tinyint unsigned NOT NULL DEFAULT \'1\' COMMENT \'是否开启\',\n  `description` varchar(200) DEFAULT NULL COMMENT \'Commet\',\n  `script` text NOT NULL COMMENT \'Script content\',\n  `record_version` int NOT NULL DEFAULT \'0\' COMMENT \'记录版本\',\n  `x` tinyint unsigned NOT NULL DEFAULT \'0\',\n  `create_time` datetime NOT NULL,\n  PRIMARY KEY (`id`) USING BTREE\n) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT=\'云函数\';', 0, 0, '2020-04-12 18:19:35');
INSERT INTO `ez_cloud_function` VALUES (4, NULL, 'a87ff679a2f3e71d9181a67b7542122c', 1, '读取Java版本', 1, '获取用户数据云函数获取用户数据云函数', '    protected R get(@PathVariable Long id) throws XException {\r\n        CloudFunction cloudFunction = iCloudFunctionService.getById(id);\r\n        if (cloudFunction == null) {\r\n            throw new BizException(\"CloudFunction not exists\", \"云函数不存在\");\r\n\r\n        }\r\n        return data(cloudFunction);\r\n    }\r\n', 0, 0, '2020-04-12 18:19:35');
INSERT INTO `ez_cloud_function` VALUES (5, NULL, 'e4da3b7fbbce2345d7772b0674a318d5', 1, '获取用户数据云函数', 1, '获取用户数据云函数获取用户数据云函数', '    protected R get(@PathVariable Long id) throws XException {\r\n        CloudFunction cloudFunction = iCloudFunctionService.getById(id);\r\n        if (cloudFunction == null) {\r\n            throw new BizException(\"CloudFunction not exists\", \"云函数不存在\");\r\n\r\n        }\r\n        return data(cloudFunction);\r\n    }\r\n', 0, 0, '2020-04-12 18:19:35');
INSERT INTO `ez_cloud_function` VALUES (6, NULL, '1679091c5a880faf6fb5e6087eb1b2dc', 1, '高级脚本', 1, '获取用户数据云函数获取用户数据云函数', '    protected R get(@PathVariable Long id) throws XException {\r\n        CloudFunction cloudFunction = iCloudFunctionService.getById(id);\r\n        if (cloudFunction == null) {\r\n            throw new BizException(\"CloudFunction not exists\", \"云函数不存在\");\r\n\r\n        }\r\n        return data(cloudFunction);\r\n    }\r\n', 0, 0, '2020-04-12 18:19:35');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ez_emqx_config` VALUES (1, '127.0.0.1', 'admin', 'public', 8081, 1883, 'emqx@127.0.0.1', 1, '默认本地节点1', 9, 0, '2020-03-06 13:56:13');
COMMIT;
...
CREATE TABLE `ez_rewrite_engine` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='脚本';

-- ----------------------------
-- Records of ez_rewrite_engine
-- ----------------------------
BEGIN;
INSERT INTO `ez_rewrite_engine` VALUES (1, 1, '消息转发到HTTP', '转发', 'hello', 0, 0, '2020-09-01 19:22:17');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `ez_user` VALUES (1, 'ezlinker', '5F4DCC3B5AA765D61D8327DEB882CF99', '1', '18059150204', 'ezlinker@ez.com.cn', 'EZLinker官方', 'EZLINKER-OfficialA', 1, 1, 0, '2020-10-15 20:06:39', '127.0.0.1', 0, 383, '2019-11-11 22:23:02');
COMMIT;
